...
import AddSupplierModel from "../../components/modals/AddSupplierModel";
  ...
  return (
    <>
      ...
      <Navbar
        ...
        descripition="Manage your pharmacy's supplier network and contact information."
      />
      ...
      <div className="flex flex-col gap-10 p-6 flex-1">
       ...
       cursor-pointer"
        ...
        <div className="border p-6 rounded-xl border-gray-300 flex flex-col gap-10">
          <h1 className="font-ui font-bold text-3xl">Supplier Directory</h1>
